...
def consultar_articulo(payload: ItemCheckRequest):
    ...
    # Detección de componentes clave en la descripción
    ...
    # Análisis combinado: Si se ingresan múltiples elementos (ej. Maletas + Estación + Soda Cáustica)
    if tiene_maletas and tiene_estacion and tiene_soda:
        return {
            "status_category": "ORIENTACIÓN ESPECIALIZADA MULTIMODAL: EQUIPAJE, ENERGÍA Y SUSTANCIAS",
            "short_answer": "Cada elemento requiere una vía específica: tus maletas van en cabina/bodega, la estación de energía por carga comercial, y la soda cáustica por carga regulada de materiales peligrosos.",
            "details": "ANÁLISIS DETALLADO Y SOLUCIÓN INTEGRAL:\n\n"
                     "1. Equipaje personal (Maletas): Cumplen con el estándar de peso (aprox. 50 lbs / 23 kg) para counter de pasajeros.\n\n"
                     "2. Estación de energía (500 Watts): Supera los límites permitidos en equipaje de pasajero. Se canaliza mediante servicio de carga comercial autorizado.\n\n"
                     "3. Soda cáustica (10 kg): Clasificada como mercancía peligrosa (material corrosivo). Está estrictamente prohibida en equipaje de mano o bodega de pasajeros; debe expedirse obligatoriamente como Carga Peligrosa (Hazmat / DGR) con embalaje certificado UN.",
            "source_reference": "Normativa Internacional IATA DGR, DOT y Estándares TSA (Verificado 2026)",
            "official_links": [
                ...
                {"title": "TSA - Artículos Prohibidos y Permitidos", "url": "https://www.tsa.gov/travel/security-screening/whatcanibring/"}
            ],
            "disclaimer": LegalNoticeManager.get_official_disclaimer()["content"]
        }

    # Caso: Maletas + Estación de energía
    if tiene_maletas and tiene_estacion:
        return {
            "status_category": "ORIENTACIÓN ESPECIALIZADA: EQUIPAJE Y ESTACIÓN DE ENERGÍA",
            "short_answer": "Tus dos maletas cumplen perfectamente con los estándares, y la estación de energía requiere canalización por carga comercial.",
            "details": "ANÁLISIS DETALLADO:\n\n"
                     "1. Equipaje personal: Dos maletas de 50 lbs (23 kg) cada una se ajustan al límite estándar permitido.\n\n"
                     "2. Estación de energía (500 Watts): Supera los límites en equipaje de pasajero por normativas de seguridad aérea. Debe viajar por servicio de carga comercial autorizado.",
            ...
            "official_links": [
                ...
                {"title": "IATA - Guía de Baterías de Litio", "url": "https://www.iata.org/en/programs/cargo/dgr/lithium-batteries/"}
            ],
            "disclaimer": LegalNoticeManager.get_official_disclaimer()["content"]
        }

    # Caso específico: Presencia de Soda Cáustica
    if tiene_soda:
        return {
            "status_category": "ORIENTACIÓN NORMATIVA: SUSTANCIAS Y MERCANCÍAS CORROSIVAS",
            "short_answer": "La soda cáustica es una sustancia regulada que exige manejo especializado fuera del equipaje de pasajeros.",
            "details": "INSTRUCCIÓN TÉCNICA DIRECTA:\n\n"
                     "1. Restricción de pasajeros: Los 10 kg de soda cáustica (material corrosivo) no están permitidos en equipaje de mano ni facturado en vuelos de pasajeros.\n\n"
                     "2. Vía de solución: Debe tramitarse estrictamente a través de un operador de carga aérea/terrestre bajo el reglamento de Mercancías Peligrosas (Dangerous Goods), utilizando embalaje homologado y declaración del expediente.",
            ...
            "official_links": [
                ...
                {"title": "DOT Hazmat Safety", "url": "https://www.phmsa.dot.gov/"}
            ],
            "disclaimer": LegalNoticeManager.get_official_disclaimer()["content"]
        }
    ...
    if tiene_estacion:
        return {
            ...
            "short_answer": "Existe una vía segura y ordenada para trasladar tu equipo mediante carga comercial.",
            "details": "INSTRUCCIÓN PRÁCTICA:\n\nLas estaciones de energía portátiles o baterías de gran potencia están sujetas a restricciones rigurosas en vuelos de pasajeros debido a su almacenamiento energético en Wh. Gestionarlo mediante carga comercial garantiza el cumplimiento normativo.",
    ...
    if tiene_maletas:
        return {
            ...
            "short_answer": "Tus maletas están dentro de los parámetros ideales para viajar sin contratiempos.",
            "details": "INSTRUCCIÓN DIRECTA:\nMantener cada pieza cerca de las 50 lbs (23 kg) garantiza un proceso fluido en el mostrador del aeropuerto.",
    ...
    # Búsqueda general por repositorio de reglas
    ...
    if rule and rule.status == RuleStatus.ACTIVA:
        ...
        return {
            ...
            "details": "PASO SUGERIDO:\nEvaluación del objeto: Si el artículo incluye mercancías especiales, pesadas o químicas, nuestra recomendación es canalizarlo con un servicio de carga o courier autorizado.",
